namespace Homework1.Models
{
	public static class RepositoryHelper
	{
		...
		public static ViewCustomerAmtReportRepository GetViewCustomerAmtReportRepository()
		{
			var repository = new ViewCustomerAmtReportRepository();
			repository.UnitOfWork = GetUnitOfWork();
			return repository;
		}

		public static ViewCustomerAmtReportRepository GetViewCustomerAmtReportRepository(IUnitOfWork unitOfWork)
		{
			var repository = new ViewCustomerAmtReportRepository();
			repository.UnitOfWork = unitOfWork;
			return repository;
